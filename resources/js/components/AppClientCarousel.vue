    ...
    export default {
        ...
        data(){
          return{
              content:[{name:'Симона и Даниела Цаневи ',text:'Много сме доволни от Боряна. Страхотно изживяване! Благодарим ти!  /26.08.2018г./'},
                  ...
                  {name:'инж.П.Арнаудова-учител',text:'Група ученици и ръководители от ПГЕЕ гр.Гълъбово бяхме на екскурзия по маршрут ' +
                      'Асенова крепост – Бачковски манастир – Пампорово - Смолян. Специални благодарности на екскурзоводът Боряна Колева! ' +
                      'С интересните си разкази тя ни представи посетените места и забележителности. С чувството си за хумор, ерудираност и ' +
                      'търпение направи пътешествието ни прекрасно! Станахме приятели! С най-голямо удоволствие бихме пътували отново с нея!'},
        ...
        methods:{
            ...
            next(){
                ...
                if(this.position+1>=-slideElements*pixel){
...
<style scoped>
   ...
   #client-img-3{
    ...
    #client-img-4{
        background-image: url("../images/happy/happy5.jpg");
    }
    .client-comment{
